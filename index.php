                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        <div class="banner__content slider__content text-center">
                            <h2 class="title wow bounceInLeft" data-wow-delay=".2s">Odyssey Bot</h2>
                            <p class="wow bounceInLeft" data-wow-delay=".4s">El mejor bot roleplay de discord de habla hispana e internacional</p>
                            <div class="banner__btn d-flex justify-content-center wow bounceInLeft" data-wow-delay=".6s">
                                <a href="contact.html" class="tg-btn-1">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-md-10">
                        <div class="section__title text-center mb-55">
                            <span class="sub-title tg__animate-text">Ultima version V2.2</span>
                            <h3 class="title">Odyssey Bot cada dia mejoramos tu experiencia de roleplay</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h4 class="match__winner-title">V2.2</h4>
                    </div>
                </div>
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-10">
                        <div class="section__title text-start mb-30">
                            <h3 class="title">Unete a nuestra comunidad </h3>
                        </div>
                        <div class="about__content-two">
                            <p>Cada dia crecemos en mas servidores y por ello nuestro servidor de discord trabaja para ayudarte 24/7 en atender dudas, problemas  y todo tipo de soporte que te pueda ayudar y nos haga crecer para mejorar.</p>
                        </div>
                        <div class="about__content-bottom">
                            <div class="about__content-circle">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" version="1.1">
                                    ...
                                    <text>
                                        <textPath href="#textPath">Odyssey Bot, Soporte</textPath>
                                    </text>
                                </svg>
                            </div>
                            <div class="about__funFact-wrap">
                                <div class="about__funFact-lists">
                                    <div class="about__funFact-item">
                                        <h2 class="count">
                                            <span class="odometer" data-count="4800"></span>
                                    ...
                                    <div class="about__funFact-item">
                                        <h2 class="count">
                                            <span class="odometer" data-count="78000"></span>
                                            <span class="formatting-mark">+</span>
                                        </h2>
                                        <p>Usuarios</p>
                                    </div>
                                ...
                                <div class="about__content-btns">
                                    <a href="about-us.html" class="tg-btn-3 tg-svg">
                                        <div class="svg-icon" id="svg-6" data-svg-icon="assets/img/icons/shape.svg"></div>
                                        <span>Entra a nuestro servidor</span>
                                    </a>
                                </div>
                            </div>
                        </div>
